...
| Yazılan dosyalar | `bin\config.ini` (ayarların), `bin\blacklist.txt` (kapsam daraltılmışsa engelli bulunan adresler), `easydpi.log` (etkinlik günlüğü; çalıştırmalar arasında saklanır, 1 MB'ta kırpılır), `dns\*.md` (çözümleyici listesi önbelleği) |
...
| `EasyDPI.exe` | bu depodaki [`src/`](src/) klasöründen derlendi | `BA98C2BF75A306A038A6888DD09A1C73C9F8652C8B9C3F7FE95626EDA410EC0C` | — |
